...
class Net(object):
    def __init__(self, lr_images, hr_images, scope):
        with tf.variable_scope(scope) as scope:
            self.construct_net(lr_images, hr_images)

    def construct_net(self, lr_images, hr_images):
